  ...
  try {
    const rows = [
      [
        ...
        { value: 'Opening Amount', fontWeight: 'bold' },
        { value: 'Purchase Amount', fontWeight: 'bold' },
        { value: 'Total Amount', fontWeight: 'bold' },
        { value: 'Used Amount', fontWeight: 'bold' },
        { value: 'Closing Amount', fontWeight: 'bold' },
        { value: 'Slip Amount', fontWeight: 'bold' },
